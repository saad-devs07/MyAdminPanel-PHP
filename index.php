...
<head>
    <meta charset="utf-8">
    <title>MultiShop - User Panel</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="category.php?category_name=<?php echo $data['C_Name'] ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" style="height: 100px;" src="AdminPanel/CategoryImages/<?php echo $data['C_Image'] ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6><?php echo $data['C_Name'] ?></h6>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        include "connection.php";
        $fetchproducts = mysqli_query($connect, 'SELECT * FROM product');
        while ($data = mysqli_fetch_Assoc($fetchproducts)) {
        ?>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" style="height:250px" src="AdminPanel/ProductImages/<?php echo $data['P_Image'] ?>" alt="">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="detail.php?id=<?php echo $data['P_ID'] ?>"><?php echo $data['P_Name']; ?></a>
        ...
        ?>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="detail.php"><?php echo $data['P_Name']; ?></a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $data['P_Price'] ?></h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
