...
<!--               <div class="brand-logo">
                <img src="AdminPanel/images/logo.svg" alt="logo">
              </div> -->
              <h4>Welcome back!</h4>
              ...
              <form class="pt-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="abc@gmail.com" name="email" required>
                  </div>
                </div>
